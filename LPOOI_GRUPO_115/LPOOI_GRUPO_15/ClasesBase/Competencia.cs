...
namespace ClasesBase
{
    ...
    {
        public Competencia(string nombre, string descripcion, DateTime fechaInicio, DateTime fechaFin,string estado, string organizador, string sponsors, string ubicacion, int catid, int disid) {
            com_Nombre = nombre;
